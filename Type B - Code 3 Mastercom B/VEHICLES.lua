...
tone_table = { "Airhorn", "Wail", "Yelp", "Priority", "Hyper", "Hyper2", "Hyper-Sweep", "Empty (Wail)", "Empty (Yelp)", "Empty (Priority)", "Powercall", "QSiren", "Fire Yelp", "Pulsed Airhorn" } 
...
DEFAULT = { 1, 2, 3, 4, 5, 6 } 						--Default is used by any vehicle without a table. 
FIRETRUK = { 12, 13, 14, 11 } 						--Fire Truck Audio (12 - Firetruck Airhorn, 13 - Firetruck Wail, 14 - Firetruck Yelp, 11 - Powercall)
AMBULAN = { 1, 2, 3, 4, 7, 11 } 					--Ambulance (1 - Airhorn, 2 - Wail, 3 - Yelp, 4 - Priority, 5 - Sweep Mode, 11 - Powercall)
