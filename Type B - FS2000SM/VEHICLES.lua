...
tone_table = { "Airhorn", "Wail", "Yelp", "Priority", "Wail-Rumbler", "Yelp-Rumbler", "Priority-Rumbler", "Sweep-1", "EMPTY", "EMPTY", "Powercall", "QSiren", "Fire Yelp", "Pulsed Airhorn" } 
...
DEFAULT = { 1, 2, 3, 4, 5, 6, 7, 8 } 			--Default is used by any vehicle without a table. 
